...
btc =
    Network
        ...
        , getMaxSatoshi = 2100000000000000
        , getXokenUserAgent = "/xoken-btc:" <> versionString <> "/"
        , getDefaultPort = 8333
        , getAllowMinDifficultyBlocks = False
        , getPowNoRetargetting = False
        , getPowLimit = 0x00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff
...
btcTest =
    Network
        ...
        , getMaxBlockSize = 1000000
        , getMaxSatoshi = 2100000000000000
        , getXokenUserAgent = "/xoken-btc-test:" <> versionString <> "/"
        ...
        , getTargetTimespan = 14 * 24 * 60 * 60
        , getTargetSpacing = 10 * 60
        , getCheckpoints = [(546, "000000002a936ca763904c3c35fce2f3556c559c0214345d31b1bcebf76acb70")]
        , getSeeds =
...
btcRegTest =
    Network
        ...
        , getMaxBlockSize = 1000000
        , getMaxSatoshi = 2100000000000000
        , getXokenUserAgent = "/xoken-btc-regtest:" <> versionString <> "/"
...
bch =
    Network
        ...
        , getMaxSatoshi = 2100000000000000
        , getXokenUserAgent = "/xoken-bch:" <> versionString <> "/"
        , getDefaultPort = 8333
        , getAllowMinDifficultyBlocks = False
        , getPowNoRetargetting = False
        , getPowLimit = 0x00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff
...
bchTest =
    Network
        ...
        , getMaxBlockSize = 32000000
        , getMaxSatoshi = 2100000000000000
        , getXokenUserAgent = "/xoken-bch-test:" <> versionString <> "/"
        , getDefaultPort = 18333
        , getAllowMinDifficultyBlocks = True
        , getPowNoRetargetting = False
        , getPowLimit = 0x00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff
...
bchRegTest =
    Network
        ...
        , getMaxBlockSize = 1000000
        , getMaxSatoshi = 2100000000000000
        , getXokenUserAgent = "/xoken-bch-regtest:" <> versionString <> "/"
        , getDefaultPort = 18444
        , getAllowMinDifficultyBlocks = True
        , getPowNoRetargetting = True
        , getPowLimit = 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
...
allNets :: [Network]
allNets = [bsv] --, btc, bch, btcTest, bchTest, btcRegTest, bchRegTest]
